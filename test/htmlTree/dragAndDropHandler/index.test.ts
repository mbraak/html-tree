...
import { DragAndDropHandler } from "htmlTree/dragAndDropHandler";
import { Node } from "htmlTree/node";
import NodeElement from "htmlTree/nodeElement";
...
describe("DragAndDropHandler", () => {
    ...
    describe(".mouseStart", () => {
        ...
        it("adds the html-tree-moving css class", () => {
            const tree = new Node(null, true);
            const node1 = new Node({ name: "node1" });
            tree.addChild(node1);
            const node2 = new Node({ name: "node2" });
            ...
            expect(node1.element?.classList).toContain("html-tree-moving");
        });
        ...
        it("creates a drag element", () => {
            ...
            expect(
                document.querySelector(".html-tree-dragging"),
            ).toBeInTheDocument();
        });
    ...
    describe(".mouseDrag", () => {
        it("moves the drag element and returns true", () => {
            ...
            const dragElement = document.querySelector(".html-tree-dragging");
        ...
        it("creates a border drop hint", () => {
            ...
            expect(
                node2.element?.querySelector(".html-tree-border"),
            ).toBeInTheDocument();
        });
        ...
        it("doesn't create a drop hint when onCanMoveTo returns false", () => {
            ...
            expect(node2.element?.querySelector(".html-tree-border")).toBeNull();
        });
