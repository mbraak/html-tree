...
describe("renderFromRoot", () => {
    ...
    it("adds the rtl class to the root list when rtl is true", () => {
        ...
        expect(screen.getByRole("tree")).toHaveClass("html-tree-rtl");
        expect(screen.getAllByRole("group")[0]).not.toHaveClass("html-tree-rtl");
    });
    ...
    it("doesn't add the rtl class to the root list when rtl is undefined", () => {
        ...
        expect(screen.getByRole("tree")).not.toHaveClass("html-tree-rtl");
    });
    ...
    it("adds the dnd class to the lists when dragAndDrop is true", () => {
        ...
        expect(screen.getByRole("tree")).toHaveClass("html-tree-dnd");
        expect(screen.getAllByRole("group")[0]).toHaveClass("html-tree-dnd");
    });
    ...
    it("doesn't add the dnd class to the lists when dragAndDrop is false", () => {
        ...
        expect(screen.getByRole("tree")).not.toHaveClass("html-tree-dnd");
        expect(screen.getAllByRole("group")[0]).not.toHaveClass("html-tree-dnd");
    });
    ...
    it("renders a closed folder", () => {
        ...
        expect(getTreeButton(treeItem)).toHaveClass("html-tree-closed");
    ...
    it("renders an open folder", () => {
        ...
        expect(getTreeListElement(treeItem)).not.toHaveClass("html-tree-closed");
        expect(getTreeButton(treeItem)).not.toHaveClass("html-tree-closed");
    ...
    it("renders a selected folder", () => {
        ...
        expect(getTreeListElement(treeItem)).toHaveClass("html-tree-selected");
    ...
    it("renders the button on the right when buttonLeft is false", () => {
        ...
        expect(treeItem).toHaveClass("html-tree-title-button-right");
        expect(getTreeButton(treeItem)).toHaveClass("html-tree-toggler-right");
        // eslint-disable-next-line testing-library/no-node-access
        expect(treeItem.nextSibling).toHaveClass("html-tree-toggler");
    });
    ...
    it("renders the button on the left when buttonLeft is true", () => {
        ...
        expect(treeItem).toHaveClass("html-tree-title-button-left");
        expect(getTreeButton(treeItem)).toHaveClass("html-tree-toggler-left");
        // eslint-disable-next-line testing-library/no-node-access
        expect(treeItem.previousSibling).toHaveClass("html-tree-toggler");
    });
